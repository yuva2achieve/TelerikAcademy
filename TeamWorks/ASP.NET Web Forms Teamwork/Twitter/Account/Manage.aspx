<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Twitter.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <img id="userPhoto" runat="server" width="140" height="140" class="img-polaroid" />
        <asp:FileUpload ID="UploadProfilePictureForm" method="post" enctype="multipart/form-data" runat="server">
            
        </asp:FileUpload>
        <asp:Button Text="Upload" runat="server"  
            ID="UploadProfilePictureButton" OnClick="UploadProfilePictureButton_Click"/>
