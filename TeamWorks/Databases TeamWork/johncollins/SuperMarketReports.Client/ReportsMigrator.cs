...
using Supermarket.Model.SalesReports;

namespace SuperMarketReports.Client
{
    public class ReportsMigrator
    {
        ...
        public ReportsMigrator(string zipFilePath)
        {
        ...
        private void GetConnectionStrings()
        {
            ...
            foreach (var keyValuePair in this.reportsPaths)
            {
                foreach (var value in keyValuePair.Value)
                {
                    ...
                    var connectionString = "Provider=Microsoft.Ace.OLEDB.12.0;Data Source=" + excelPath + ";Extended Properties=Excel 8.0;";
