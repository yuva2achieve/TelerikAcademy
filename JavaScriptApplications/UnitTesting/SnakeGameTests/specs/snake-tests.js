describe("Snake", function () {
  ...
  describe("grow", function () {
    it("Snake should increase it's size", function () {
      var currentSize = snake.size;
      snake.grow();
      expect(snake.size).toBe(currentSize + 1);
    })

    it("Snake should increase it' pieces count", function () {
      var currentPiecesCount = snake.pieces.length;
      snake.grow();
      expect(snake.pieces.length).toBe(currentPiecesCount + 1);
    })
  })
