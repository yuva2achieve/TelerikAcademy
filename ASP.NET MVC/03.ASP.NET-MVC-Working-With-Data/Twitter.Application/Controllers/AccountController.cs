...
namespace Twitter.Application.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            IdentityManager = new AuthenticationIdentityManager(new IdentityStore(new TwitterContext()));
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                user.ProfilePicture = "https://si0.twimg.com/sticky/default_profile_images/default_profile_4_reasonably_small.png";
